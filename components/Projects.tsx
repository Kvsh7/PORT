    ...
    >
      ...
      >
        ...
        <div className="h-56 overflow-hidden relative z-0">
          ...
          {/* Overlay */}
          <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-10 backdrop-blur-[2px] gap-3">
             <a 
               href={project.link} 
               className="px-6 py-2 bg-chroma-primary text-white rounded-full font-bold transform scale-90 group-hover:scale-100 transition-transform shadow-[0_0_15px_rgba(99,102,241,0.5)] hover:shadow-[0_0_25px_rgba(99,102,241,0.8)]"
             >
               View Details
             </a>
             {project.githubUrl && (
               <a 
                 ...
                 className="p-3 bg-white/10 text-white rounded-full hover:bg-white/20 transition-colors transform scale-90 group-hover:scale-100 shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]"
